...
<Info>
This feature is enabled by default. When enabled, if your Discord account is linked and you are a member of our [Discord server](https://discord.gg/hauntbio), you will receive direct messages for account-related actions, such as kicks or bans.
</Info>

<Steps>
  <Step title="Visit Account Settings">
    Go to [haunt.gg/dashboard/settings](https://haunt.gg/dashboard/settings).
  </Step>
  <Step title="Enable or Disable">
    Find the **Discord Connection** section and enable or disable this feature.
  </Step>
</Steps>

<Frame>
    ![Discord Notification Settings](../images/discord-notifications.png)
</Frame>
